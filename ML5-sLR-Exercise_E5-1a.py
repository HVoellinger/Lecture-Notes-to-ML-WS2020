...
#  
# The example is from Lecture: "ML_Concept&Algorithm" (WS2020); Chapter ML5, Exercise E5.1-a
#  "Exam Results" 
#  
...
# 
# The value 𝑏₀ = 14.1170 (approximately) illustrates that your model predicts the response 14.1170 when 𝑥 is zero. The value 𝑏₁
# = 3.7376 means that the predicted response rises by 3.7376 when 𝑥 is increased by one.
# 
