...
#  
# The example is from Lecture: "ML_Concept&Algorithm" (WS2020); Chapter ML5, Exercise E5.1-b
#  "Exam Results" 
#  
...
print ("***** X-axis --> hours of effort for homework; Y-axis -->score-points *******")
print ("*****************************************************************************") 
...
x = np.array([ 5, 4, 5, 3, 9, 8, 10, 5, 3, 3]).reshape((-1, 1))
...
# 
# The value 𝑏₀ = 15.1636 (approximately) illustrates that your model predicts the response 15.1636 when 𝑥 is zero. The value 𝑏₁
# = 3.4793 means that the predicted response rises by 3.4793 when 𝑥 is increased by one.
# 
